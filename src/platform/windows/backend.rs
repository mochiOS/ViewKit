...
pub struct WindowsBackend<A> {
    ...
    windows: HashMap<WindowId, WindowsWindowState>,
    ...
    A: PlatformApplication,
{
    ...
    fn create_window(
        ...
        let renderer = WindowsRenderer::new(context, window.clone(), viewport)?;
    ...
    fn window_event(
        ...
        match event {
            ...
            WindowEvent::Resized(size) => {
                let viewport = viewport_from_physical(size, window.scale_factor());
            ...
            WindowEvent::ScaleFactorChanged { scale_factor, .. } => {
                let viewport = viewport_from_physical(window.inner_size(), scale_factor);
