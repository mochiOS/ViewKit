use viewkit::components::{Background, Padding, Rectangle, RectangleColor, Text, VStack};
use viewkit::draw_command::{DisplayList, DrawCommand};
use viewkit::geometry::Size;
use viewkit::layout::{StackAlignment, StackDistribution, ViewExt};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let backend = LinuxBackend::new(
        application,
        WindowConfig {
            title: String::from("ViewKit Text Example"),
